...
function networkOf(ip) {
  ...
  return `${parts[0]}.${parts[1]}.${third - (third % 4)}.0/22`;
}
...
function providerName(value = '') {
  return String(value)
    ...
    .replace(/\b(Llc|Inc|Ltd|Isp|As)\b/g, word => word.toUpperCase()) || '未知';
}
